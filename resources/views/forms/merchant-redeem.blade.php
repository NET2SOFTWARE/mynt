<section class="form-group row{{ $errors->has('sender') ? ' has-danger' : '' }}">
    ...
    <section class="col-sm-8">
        <input id="sender" name="sender" class="form-control disabled" value="{{ Auth::user()->merchants->first()['accounts'][0]['number'] }}" placeholder="Sender account number" aria-describedby="senderHelp" readonly>
