    ...
    <article class="col d-flex justify-content-center">
        <section class="align-self-center con-sign-in">
            <header class="col-md-12">
                <h4 class="mb-1">Merchant&nbsp;&nbsp;<span class="text-grey">&#124;</span>&nbsp;&nbsp;<small>Sign In</small></h4>
                <h6 class="medium mb-0">Please use your valid mynt account.</h6>
            </header>
            <section class="col-md-12 py-3">
                <form class="form-signin" method="POST" action="{{ route('post.login.merchant') }}" role="form" accept-charset="utf-8">
                    {{ csrf_field() }}
