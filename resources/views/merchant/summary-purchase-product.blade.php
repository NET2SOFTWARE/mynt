                ...
                <section class="card my-3" style="min-height:560px">
                    <section class="card-header">
                        <ul class="nav nav-tabs card-header-tabs medium-small">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('merchant.summary.payment') }}">MYNT Payment Product</a></li>
                            <li class="nav-item"><a class="nav-link active" href="{{ route('merchant.summary.purchase') }}">MYNT Purchase Product</a></li>
                        </ul>
                    </section>
