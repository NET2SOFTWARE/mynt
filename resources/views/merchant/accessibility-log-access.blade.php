                ...
                <section class="card my-3" style="min-height:556px">
                    <section class="card-header">
                        <ul class="nav nav-tabs card-header-tabs medium-small">
                            <li class="nav-item"><a class="nav-link" href="{{ route('merchant.accessibility.notification') }}">Notification</a></li>
                            <li class="nav-item"><a class="nav-link active" href="{{ route('merchant.accessibility.log_access') }}">Log access</a></li>
                        </ul>
                    </section>
