        ...
        <section class="row">
            ...
            <section class="main col-sm-9 offset-sm-3 col-md-10 offset-md-2 p-0">
                <section class="header-content justify-content-between align-items-baseline">
                    <section>
                        <p class="medium lh-1-5 mb-0">MEMBER DETAILED TRANSACTIONS</p>
                    </section>
                    <section class="d-flex justify-content-between align-content-st align-items-baseline">
                        <section class="d-flex justify-content-between align-content-start">
                            <section class="btn-group btn-group-sm">
                                <a href="{{ route('member.detail.transactions.index', [$member->id]) }}" class="btn btn-secondary">Refresh</a>
                            </section>
                        </section>
                        <form action="{{ route('member.detail.transactions.sort', [$member->id]) }}" method="POST" class="input-group input-group-sm ml-3" role="form">
                            {{ csrf_field() }}
                ...
                <section class="header-content justify-content-between align-items-baseline">
                    <section class="btn-group btn-group-sm">
                        <a href="{{ route('member.transactions') }}" class="btn btn-secondary"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
                    </section>
                    <section>
                        <p class="medium lh-1-5 mb-0"><span class="badge badge-info">{{ $member->name }}</span></p>
                    </section>
                </section>
