        ...
        <section class="row">
            ...
            <section class="main col-sm-9 offset-sm-3 col-md-10 offset-md-2 p-0">
                ...
                <section class="col-sm-8 offset-sm-2 py-3">
                    ...
                    <h5>Update partnership</h5>
                    <h6 class="medium-small">Please insert with valid data.</h6>
                    <hr class="clearfix"/>

                    <form method="post" action="{{ route('partnership.update', [$partnership->id]) }}" accept-charset="utf-8" role="form">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        ...
                        <section class="card card-block p-5">
                            ...
                            <fieldset class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input id="name" name="name" class="form-control" value="{{ $partnership->name }}" placeholder="Partnership name" type="text" aria-describedby="nameHelp">
                            ...
                            <fieldset class="form-group">
                                ...
                                <textarea id="description" rows="5" name="description" placeholder="Partnership description..." class="form-control" aria-describedby="descriptionHelp">{{ $partnership->description }}</textarea>
