        ...
        <section class="row">
            ...
            <section class="main col-sm-9 offset-sm-3 col-md-10 offset-md-2 p-0">
                <section class="header-content justify-content-between align-items-baseline">
                    <section>
                        <p class="medium lh-1-5 mb-0">MERCHANT DETAILED TRANSACTIONS</p>
                    </section>
                    <section class="d-flex justify-content-between align-content-st align-items-baseline">
                        <section class="d-flex justify-content-between align-content-start">
                            <section class="btn-group btn-group-sm">
                                <a href="{{ route('merchant.transactions', [$merchant->id]) }}" class="btn btn-secondary">Refresh</a>
                            </section>
                        </section>
                        <form action="{{ route('merchant.detail.transactions.sort', [$merchant->id]) }}" method="POST" class="input-group input-group-sm ml-3" role="form">
                            {{ csrf_field() }}
                ...
                <section class="header-content justify-content-between align-items-baseline">
                    <section class="btn-group btn-group-sm">
                        <a href="{{ route('merchant.transactions.index') }}" class="btn btn-secondary"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
                    </section>
                    <section>
                        <p class="medium lh-1-5 mb-0"><span class="badge badge-info">{{ $merchant->name }}</span></p>
                    </section>
                </section>
