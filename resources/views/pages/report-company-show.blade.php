        ...
        <section class="row">
            ...
            <section class="main col-sm-9 offset-sm-3 col-md-10 offset-md-2 p-0">
                <section class="header-content justify-content-between align-items-baseline">
                    <section>
                        <p class="medium lh-1-5 mb-0">REPORT COMPANY</p>
                    </section>
                    <section class="d-flex justify-content-between align-content-start align-items-baseline">
                        <section class="mr-2">
                            <section class="btn-group btn-group-sm">
                                <a href="{{ route('report.company.index') }}" class="btn btn-secondary">Back</a>
                            </section>
                        </section>
                        <section class="d-flex justify-content-between align-content-start">
                            <section class="btn-group btn-group-sm">
                                {{-- <a href="{{ route('report.company.print') }}" class="btn btn-secondary">Print</a> --}}
                                <a href="{{ route('report.company.index') }}" class="btn btn-secondary">Refresh</a>
                            </section>
                        </section>
                    </section>
                </section>
                                ...
                                <table class="table small mb-0 h-100" style="border-right: 1px solid #e9eaec;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="p-3 text-right">{{ $data['count_member'] }}</td>
                                        </tr>
                                        <tr>
                                            <td class="p-3">
                                                <strong>
                                            ...
                                            <td class="p-3 text-right">{{ $data['count_merchant'] }}</td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                        ...
                        <div class="row p-0" style="min-height:200px;">
                            <div class="col-md-8">
                                <table class="table small mb-0 h-100" style="border-right: 1px solid #e9eaec;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="p-3"><strong>All Accounts</strong></td>
                                            <td class="p-3 text-right">{{ $data['count_account'] }}</td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                ...
                                <div class="row p-0">
                                    <div class="col-md-12">
                                        <table class="table small mb-0">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td class="p-3 text-muted"><strong>Total Income</strong></td>
                                        ...
                                        <table class="table small mb-0">
                                            <thead>
                                                <tr>
                                                    <th colspan="2">
                                                        <p class="lead m-0 p-2">
                                                            <span class="badge badge-default small-caps">{{ strtolower($data['company']->name) }}</span>
                                                        </p>
                                                    </th>
                                                </tr>
                                            </thead>
