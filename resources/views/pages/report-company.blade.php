    ...
    <article class="container-fluid">
        <section class="row">
            ...
            <section class="main col-sm-9 offset-sm-3 col-md-10 offset-md-2 p-0">
                ...
                <form method="POST" action="{{ route('report.company.show') }}" accept-charset="utf-8" role="form">
                {{ csrf_field() }}

                    <section class="col-md-6 offset-md-3 mt-5">
                        <fieldset class="form-group">
                            <label class="pl-2">Select a company</label>
                        ...
                        <fieldset class="form-group">
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-md-5 pl-0">
                                    <select name="month" class="form-control custom-select" disabled>
