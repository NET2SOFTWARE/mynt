                    ...
                    <section class="d-flex justify-content-between align-content-st align-items-baseline">
                        <section class="mr-2">
                            <section class="btn-group btn-group-sm">
                                <a href="{{ route('report.merchant.index') }}" class="btn btn-secondary">Back</a>
                            </section>
                        </section>
                        <section class="d-flex justify-content-between align-content-start">
                            <section class="btn-group btn-group-sm">
                                {{-- <a href="{{ route('report.merchant.print') }}" class="btn btn-secondary">Print</a> --}}
                                        ...
                                        <table class="table small mb-0">
                                            <thead>
                                                <tr>
                                                    <th colspan="2">
                                                        <p class="lead m-0 p-2">
                                                            <span class="badge badge-default small-caps">{{ strtolower($data['merchant']->name) }}</span>
                                                        </p>
                                                    </th>
                                                </tr>
                                            </thead>
