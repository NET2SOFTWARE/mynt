        ...
        <section class="row">
            ...
            <section class="main col-sm-9 offset-sm-3 col-md-10 offset-md-2 p-0">
                ...
                <section class="col-sm-8 offset-sm-2 py-3">
                    ...
                    <form method="post" action="{{ route('industry.update', [$industry->id]) }}" accept-charset="utf-8" role="form">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        ...
                        <section class="card card-block p-5">
                            ...
                            <fieldset class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input id="name" name="name" class="form-control" value="{{ $industry->name }}" placeholder="industry name" type="text" aria-describedby="nameHelp">
                        ...
                        <section class="form-group mt-4">
                            <a href="{{ route('industry.index') }}" class="btn btn-secondary">Back to instution</a>
                            <button type="submit" class="btn btn-primary float-right" role="button">Save instution</button>
                        </section>
                    </form>
                </section>
            </section>
