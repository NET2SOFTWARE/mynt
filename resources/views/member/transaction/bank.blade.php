                ...
                <section class="card my-3" style="min-height:560px">
                    <section class="card-header">
                        <ul class="nav nav-tabs card-header-tabs medium-small">
                            ...
                            @if(Auth::user()->members->first()->isRegistered() && (!Auth::user()->isChildAccount()))
                                <li class="nav-item"><a class="nav-link active" href="{{ route('member.transactions.bank') }}">Transfer to Bank</a></li>
                    ...
                    <section class="card-block">
                        <section class="col-md-8 offset-md-2">
                            <form action="" method="POST" class="py-4" accept-charset="utf-8" role="form">
                                {{ csrf_field() }}
                                ...
                                <section class="form-group row">
                                    ...
                                    <section class="col-sm-8">
                                        ...
                                        <small class="form-text text-muted d-flex justify-content-between">Numeric only, min : 500 <span class="text-grey">Required</span></small>
                                    </section>
                                </section>
                                ...
                                <section class="form-group row mt-4">
                                    <section class="col-sm-8 offset-sm-4">
                                        <button class="btn btn-block btn-primary" type="submit" role="button">Process Transfer</button>
                                    </section>
                                </section>
                            </form>
                        </section>
