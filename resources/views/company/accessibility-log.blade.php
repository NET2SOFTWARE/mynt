                ...
                <section class="card mt-3" style="min-height:624px">
                    <section class="card-header">
                        <ul class="nav nav-tabs card-header-tabs medium-small">
                            <li class="nav-item"><a class="nav-link" href="{{ route('company.accessibility.notification') }}">Notification</a></li>
                            <li class="nav-item"><a class="nav-link active" href="{{ route('company.accessibility.log') }}">Log Access</a></li>
                        </ul>
                    </section>
