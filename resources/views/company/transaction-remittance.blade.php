                ...
                <section class="card mt-3" style="min-height:624px">
                    <section class="card-header">
                        <ul class="nav nav-tabs card-header-tabs medium-small">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="{{ route('company.transaction.remittance') }}">Remittance to Cash</a></li>
                            <li class="nav-item ml-auto"><a class="nav-link" href="{{ route('company.transaction.redeem') }}">Redeem</a></li>
                        </ul>
                    </section>
                    <section class="card-block d-flex justify-content-center align-items-center align-content-center">
                        <section class="w-75">
                            ...
                            @endif
                            <form action="{{ route('cash.out') }}" method="POST" accept-charset="utf-8" role="form">
                                {{ csrf_field() }}
                                @include('forms.company-remittance')
                            </form>
                        </section>
                    </section>
                </section>
