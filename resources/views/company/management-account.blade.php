                ...
                <section class="card" style="min-height:620px">
                    <section class="card-header">
                        <ul class="nav nav-tabs card-header-tabs medium-small">
                            <li class="nav-item"><a class="nav-link active" href="{{ route('company.management.account') }}">Account management</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('company.management.bank') }}">Bank management</a></li>
                        </ul>
                    </section>
