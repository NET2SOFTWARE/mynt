...
Route::group(['middleware' => ['auth', 'confirmation', 'mynt']], function () {
    ...
    Route::prefix('user/member')->group(function () {
        ...
        Route::get('/management/bank',                      'Member\ManagementController@bank')->name('member.management.bank');
        Route::post('/management/bank',                     'RemittanceController@register')->name('member.management.bank.store');
        Route::get('/management/bank/register',             'Member\ManagementController@showFormRegisterBank')->name('member.management.create');
    ...
    Route::prefix('user/merchant')->group(function () {
        ...
        Route::get('/management/bank/create',       'Merchant\ManagementController@showFormRegisterBank')->name('merchant.management.bank.create');
